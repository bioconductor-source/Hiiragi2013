...
@
%
\incfig{figClue1}{0.8\textwidth}{Cluster stability analysis wit E3.25 and E3.5 WT samples.}{Left:
...
points(seq_len(nrow(py)), rep(par("usr")[3]+0.2, nrow(py)), pch = 16, col = x325$sampleColour)
@
%
