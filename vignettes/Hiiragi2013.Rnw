...
\title{{\Large Executable Analysis Document Supporting:}\\
  ...
  {\Large Yusuke Ohnishi, Wolfgang Huber, Akiko Tsumura, Minjung Kang, Panagiotis Xenopoulos, Kazuki Kurimoto, Andrzej Ole\'s, 
...
resampledSampleSet = clusterResampling(x[!FGF4probes, sampleSets], ngenes=20)
set.seed(2012)
@
